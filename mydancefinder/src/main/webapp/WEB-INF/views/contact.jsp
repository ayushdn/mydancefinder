...
<style>
/*    body {
  background-image: url("<c:url value='/resources/images/z.jpg'/>");
 ...
 overflow:hidden;
 background-image:url("resources/images/z.jpg"); 
...
<figure>
	<div class="container mt-5">
		...
		<form action="processform" method="post" onsubmit="alert('Successfully Submitted..')">
...
<div class="form-group">
			...
			<div class="container mt-5 text-center">
				...
				<button type="submit" onclick="window.location.href = 'thankyou';"  class="btn btn-primary">Submit</button>
